...
class BomStructureReport(models.AbstractModel):
    ...
    def get_children(self, object, level=0):
        ...
        def _get_rec(object, level, qty=1.0, uom=False):
            for l in object:
                ...
                ## Append new fields on BOM to print on Report
                res['material'] = l.material
                res['machine_drawing_no'] = l.machine_drawing_no
                res['casting_drawing_no'] = l.casting_drawing_no
                res['raw_size'] = l.raw_size
                res['finished_size'] = l.finished_size
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('IV_mrp.mrp_bom_structure_report_iv_inherited', docargs)
