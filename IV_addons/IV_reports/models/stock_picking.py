...
class StockPicking(models.Model):
    ...
    def do_print_picking(self):
        ...
        if self.picking_type_id.code == 'incoming':
            report_id = self.env["report"].get_action(self, 'IV_reports.report_incoming_shipment')
            ...
            report_id = self.env["report"].get_action(self, 'IV_reports.report_deliveryslip_inherited')
